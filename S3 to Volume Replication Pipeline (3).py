...
class ReplicationConfig:
    # S3 source settings
    source_bucket: str = "stg-forte-us-east-2-forte-ses-inbound"
    source_prefix: str = "icon-ereg-stg"           # s3://<bucket>/<prefix>/<uuid>/

    # Destination: Databricks Volume path
    dest_volume_path: str = "/Volumes/dbx_dev_data_refine/export/ereg/s3_replication"
